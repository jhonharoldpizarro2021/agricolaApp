                ...
                if( $con )
                {
                  ...
                  ?>
                    <tr class="<?php echo $class ?> gradeX">
                      ...
                      <td class="center">
                        <a  class="fa fa-pencil-square-o" aria-hidden="true" onclick="modificarUsuario('<?= $row["id_usuarios"] ?>','<?= utf8_encode( $row["nombre"] ) ?>',
                      ...
                      <td class="center">
                        <a  class="fa fa-trash-o" aria-hidden="true" onclick="elimnarUsuario('<?= $row["id_usuarios"] ?>')"></a>
                      </td>
                    </tr>
                <?php
                  }
