...
<script type="text/javascript" src="js/tchm_vs_corte.js?n=<?= time() ?>"></script>
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
  <div id="page-wrapper">
    <!-- row -->
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-eyedropper fa-fw"></i> Informe TCHM -vs- Corte por Finca</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel"><i class="fa fa-eyedropper fa-fw"></i> Informe TCHM -vs- Corte por Finca</h4>
                </div>
