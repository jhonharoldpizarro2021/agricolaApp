...
<script type="text/javascript" src="js/tc_vs_pluviometria.js?n=<?= time() ?>"></script>
<script type="text/javascript">
  ...
  <div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-eye fa-fw"></i> Informe Pluviometr&iacute;a</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                        ...
                        <div class="col">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Generar Informe Pluviometr&iacute;a por Finca
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" id="formNueva">
                                            <form role="form" id="registroPluviometria">
                                                ...
                                                <button type="button" onclick="informeFinca()" id="form-submit" class="btn btn-default pull-right ">Crear</button>
