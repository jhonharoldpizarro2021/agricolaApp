...
<script type="text/javascript" src="js/informe_pluviometria_anno_mes.js?n=<?= time() ?>"></script>
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
  <div id="page-wrapper">
    <!-- row -->
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-eyedropper fa-fw"></i> Informe Pluviometr&iacute;a Año -vs- Mes</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <div class="row">
                    <div class="col-md-6">
                      <button type="button" class="btn btn-default btn-circle btn-lg informeFinca" data-toggle="modal" data-target="#informeFinca"><i class="fa fa-plus"></i></button> <h4> Generar Nuevo Informe</h4>
                    </div>
                    <!-- <div class="col-md-6">
                ...
                <div class="panel-body" id="resultado">
                  <div class="panel panel-tierra">
                      <div class="panel-heading">
                          <h4 id="nFinca">Nombre de la Finca</h4>
                      </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel"><i class="fa fa-eyedropper fa-fw"></i> Informe de Pluviometr&iacute;a Año -vs- Mes</h4>
                </div>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <?php
                                                        ...
                                                        if( $con )
                                                        {
                                                            $query = " SELECT * FROM qryyearPluviometria ";
                                                            $resultado = mysqli_query($con, $query);
                                                    ?>
                                                    <select id="año" name="año" class="form-control">
                                                      <option value="NULL" disabled selected="true" >Seleccionar A&ntilde;o</option>
                                                      <?php
                                                          while( $row = mysqli_fetch_array( $resultado ) )
                                                              {
                                                                echo '<option value="'.$row['YEAR(fecha)'].'">'. utf8_encode($row['YEAR(fecha)']) .'</option>';
                                                              }
                                                          if( !close_bd($con) )
                                                          {
                                                            echo "Error al cerrar la BDD";
