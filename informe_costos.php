...
<link rel="stylesheet" href="extensions/morrisjs/morris.css">
<script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
  <script src="extensions/morrisjs/morris.min.js"></script>
<script type="text/javascript" src="js/informe_costos.js?n=<?= time() ?>"></script>
  ...
  <div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-calculator fa-fw"></i> Informe Costos por Finca</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel"><i class="fa fa-calculator fa-fw"></i> Informe Costos por Finca</h4>
                </div>
