<?php include "header.php"; ?>
  <script type="text/javascript" src="js/costos-indirectos.js"></script>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-list-alt fa-fw"></i> Lista de Costos Indirectos</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <button type="button" class="btn btn-default btn-circle btn-lg nuevaunidad" data-toggle="modal" data-target="#nuevoCosto"><i class="fa fa-plus"></i></button> Agregar Costo Indirecto
                        </div>
                        <!-- Modal Nueva Medida-->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                      ...
                                      <h4 class="modal-title" id="myModalLabel"><i class="fa fa-list-alt fa-fw"></i> Costos Indirectos</h4>
                                    </div>
                                                                ...
                                                                <form role="form" id="tiempo">
                                                                    ...
                                                                    <div class="form-group" style="display:none;">
                                                                        <select id="tipo"  disabled name="tipo" class="form-control">
                                                                          <option value="2"  selected="true" >Costo Indirecto</option>
                                                                        </select>
                                                                    </div>                                                                  
